...
def sample_billing_results():
    ...
    return [
        ...
        BillingResult(
            ...
            cost_per_hour=Decimal("115.00"),
            revenue=Decimal("2100.00"),
            cost=Decimal("1380.00"),
            profit=Decimal("720.00"),
            profit_margin=Decimal("34.29"),
            travel_surcharge_hours=Decimal("10.0"),
            travel_surcharge_revenue=Decimal("262.50"),
            travel_surcharge_cost=Decimal("172.50"),
        ),
    ]
